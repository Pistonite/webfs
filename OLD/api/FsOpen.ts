import { tryCatch, tryAsync, errstr } from "@pistonite/pure";
...
export async function fsOpenReadFromTransferItem(
...
export async function fsOpenReadWriteFromTransferItem(
    item: DataTransferItem,
    retryHandler?: FsOpenRetryHandler,
): Promise<FsResult<FsFileSystem>> {
